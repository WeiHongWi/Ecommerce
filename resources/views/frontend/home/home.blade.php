...
@section('content')
    ...
    @include('frontend.home.sections.sell')


    @include('frontend.home.sections.top')
    ...
    @include('frontend.home.sections.hot_deal')


    @include('frontend.home.sections.product_one')


    @include('frontend.home.sections.product_two')


    @include('frontend.home.sections.larger_banner')


    @include('frontend.home.sections.week_best')


    @include('frontend.home.sections.home_service')


    @include('frontend.home.sections.home_blog')
